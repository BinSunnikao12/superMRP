# 集团 MRP 系统需求 v0.5（开发就绪版 · MVP-1）

> **演进**：v0.3 已归档到 [archive/v0.3-2026-07-24.md](./archive/v0.3-2026-07-24.md)、v0.4 已归档到 [archive/v0.4-2026-07-24.md](./archive/v0.4-2026-07-24.md)
> **当前版本**：v0.5 — 2026-07-24
> **本次关键变化**：
> 1. 文档 2 第 4 张图（完整分解流程图）已抓取
> 2. **d.ii 采购物料完整规则**（划线剔除）：供应商/采购业务员/自制转采购
> 3. 文档 2 五/六/七/八章节完整抓到（非功能需求、业务流程、接口、验收、附录）
